...
**Status: RTI-1 complete on `main`. RTI-2 (File Requirements Ingestion) implemented, awaiting independent review (not merged). ID-3 planning remains complete but its implementation is explicitly deferred in priority behind this arc - see below.**
