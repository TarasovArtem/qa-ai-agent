...
Both human-review records (`scripts/ai/generative-test-design/test-design-review-record.js` for #22F, `scripts/ai/test-automation/generated-change-set-review-record.js` for #23E) bind the reviewed artifact and the reviewer's decision into a SHA-256 content digest, and both carry the same explicit self-documented limitation, verbatim in both files: **"INTEGRITY IS NOT AUTHENTICITY."**
